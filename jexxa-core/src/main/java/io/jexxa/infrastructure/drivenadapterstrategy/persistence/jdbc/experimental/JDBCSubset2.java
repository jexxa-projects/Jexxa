...
public class JDBCSubset2<T,S, M extends Enum<M> & SearchStrategy> implements ISubset<T, S>
{
    ...
    public JDBCSubset2(JDBCRepository jdbcRepository, RangeComparator2<T, S> rangeComparator2, M nameOfRow, Class<T> aggregateClazz, Class<M> comparatorSchema)
    {
        this.jdbcRepository = jdbcRepository;
        this.aggregateClazz = aggregateClazz;
        this.nameOfRow = nameOfRow;
        this.rangeComparator = rangeComparator2;
