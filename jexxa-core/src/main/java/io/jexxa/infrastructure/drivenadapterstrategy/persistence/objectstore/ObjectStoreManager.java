...
public final class ObjectStoreManager
{
    ...
    public static  <T,K,M  extends Enum<?> & MetadataConverter> IObjectStore<T,K, M> getObjectStore(
    ...
    @CheckReturnValue
    public <T,K,M  extends Enum<?> & MetadataConverter> IObjectStore<T,K,M> getStrategy(
            Class<T> objectClazz,
            Function<T,K> keyFunction,
            Class<M> comparatorFunctions,
            Properties properties
