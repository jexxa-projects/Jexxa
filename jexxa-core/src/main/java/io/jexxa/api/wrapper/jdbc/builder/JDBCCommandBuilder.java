...
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.AND;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.ARGUMENT_PLACEHOLDER;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.BLANK;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.COMMA;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.DELETE;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.FROM;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.INSERT_INTO;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.OR;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SET;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.EQUAL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.UPDATE;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.WHERE;
