...
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.ARGUMENT_PLACEHOLDER;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.EQUAL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.GREATER_THAN;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.GREATER_THAN_OR_EQUAL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.IS_NOT_NULL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.IS_NULL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.LESS_THAN;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.LESS_THAN_OR_EQUAL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.LIKE;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.NOT_EQUAL;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SQLOperation.NOT_LIKE;
