...
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.LIMIT;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.OR;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.ORDER_BY;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SELECT;
import static io.jexxa.api.wrapper.jdbc.builder.SQLSyntax.SELECT_COUNT;
