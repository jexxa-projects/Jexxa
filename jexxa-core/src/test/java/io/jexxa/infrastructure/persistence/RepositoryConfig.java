package io.jexxa.infrastructure.persistence;
...
public class RepositoryConfig {
    ...
    public static Properties postgresRepositoryConfig(String schemaName) {
        ...
        postgresProperties.put(JDBCProperties.JDBC_PASSWORD, USER_PASSWORD);
        postgresProperties.put(JDBCProperties.JDBC_USERNAME, USER_NAME);
        postgresProperties.put(JDBCProperties.JDBC_URL, "jdbc:postgresql://localhost:5432/" + schemaName);
    ...
    public static Properties postgresRepositoryConfigSerializable(String schemaName) {
        ...
        postgresProperties.put(JDBCProperties.JDBC_AUTOCREATE_TABLE, "true");
        postgresProperties.put(JDBCProperties.JDBC_AUTOCREATE_DATABASE, "jdbc:postgresql://localhost:5432/postgres");
        postgresProperties.put(JDBCProperties.JDBC_TRANSACTION_ISOLATION_LEVEL, "serializable");
        return  postgresProperties;
    }
    ...
    public static Properties postgresRepositoryConfigRepeatableRead(String schemaName) {
        ...
        postgresProperties.put(JDBCProperties.JDBC_AUTOCREATE_TABLE, "true");
        postgresProperties.put(JDBCProperties.JDBC_AUTOCREATE_DATABASE, "jdbc:postgresql://localhost:5432/postgres");
        postgresProperties.put(JDBCProperties.JDBC_TRANSACTION_ISOLATION_LEVEL, "repeatable-read");
        return  postgresProperties;
    }
    ...
    public static Properties h2RepositoryConfig() {
        ...
        h2Properties.put(JDBCProperties.JDBC_PASSWORD, USER_PASSWORD);
        h2Properties.put(JDBCProperties.JDBC_USERNAME, USER_NAME);
        h2Properties.put(JDBCProperties.JDBC_URL, "jdbc:h2:mem:jexxa;DB_CLOSE_DELAY=-1");
