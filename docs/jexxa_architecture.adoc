...
* Because your senior and intermediate developers focus on the application core, your younger developers must focus on the technology stack.
...
In the rest of this section the design decisions of the most important aspects are explained.
