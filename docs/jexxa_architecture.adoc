...
IMPORTANT: <<JexxaComponents>> shows that you can focus on your application core. The infrastructure of your application is just an ultra-thin facade to be independent of Jexxa.
