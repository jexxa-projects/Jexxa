...
NOTE: Jexxa provides a reconnection mechanism for all provided driving- and driven-adapter. But this reconnection mechanism is only used after an initial successfully start.
