...
==== Secrets
One of the most crucial aspects with productive systems is the handling of secrets uch as usernames, passwords, or private keys. Jexxa addresses this problem with two approaches.
