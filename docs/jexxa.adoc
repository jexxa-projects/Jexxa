...
* A well-defined interface to integrate arbitrary technology stacks as adapters.
* A fluent API to connect your application core to available adapters. The main method explicitly represents the binding between ports and adapters so that you can exchange technology stacks independently.
