...
* A fluent API to connect your application core to available adapters. The main methods explicitly represents the binding between ports and adapters so that you can exchange technology stacks individually.
