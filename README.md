...
```groovy
compile "io.Jexxa:jexxa-web:3.0.1"
``` 
...
Available properties are described [here](https://github.com/repplix/Jexxa/blob/master/jexxa-core/src/main/test/resources/jexxa-application.properties)
