...
| Port Adapter
a| Is always created new and not reused at all. 
...
Instead, we recommend building your ports of the application core so that it provides an idempotent semantic.
