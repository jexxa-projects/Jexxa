...
.This figure shows the separation of a typical Jexxa application into packages, the included components, and the relationship of the components among each other.
[[JexxaComponents]]
...
Within Jexxa you can control the used dependencies by defining the packages for the application core and the infrastructure independently. 
