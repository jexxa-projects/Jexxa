...
*   How to use a so called specific adapter from Jexxa together with a application specific driving adapter    
...
*   In case we use JMS, we connect JMSAdapter to a our application specific port adapter.     
